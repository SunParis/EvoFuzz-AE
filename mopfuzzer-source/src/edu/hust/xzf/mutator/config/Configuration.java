...
public class Configuration {
    ...
    public static String orgProjectPath;
...
//            + "--add-exports java.base/jdk.internal.org.objectweb.asm=ALL-UNNAMED ";
    ...
    public static String rcovJavaHome;

    public static boolean enableScheduler;
    public static boolean enableRcovRunAnyWay;

    public String fullSrcName = null;
    ...
    public void settingAll() {
        ...
        if (this.targetCase.startsWith("/")) {
            this.javaFilePath = this.targetCase;
        }
