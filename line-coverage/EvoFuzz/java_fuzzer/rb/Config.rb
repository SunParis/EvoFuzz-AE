...
OP_TYPES   = {'boolean' => {'oper'=>['relational', 'boolean'], 'assn'=>['boolean_assn']},
    ...
    'String'  => {'oper'=>['string_oper'], 'assn'=>['string_assn']},
...
class ProbTab
    ...
    def getRand(subSet=nil, exclSubSet=nil)
        ...
        # print("subInd" + subInd.to_s + "\n")
        # print("subSet" + subSet.to_s + "\n")
        @values[wrand(subInd)]
    end
...
class Conf
    ...
    def initialize(parse_args=false)
        ...
        @max_callers_chain = 5 # Maximum chain of methods calling each other (including constructors)
        ...
        @types = ProbTab.new({'Array'=>2, 'Object'=>1, 'boolean'=>1, 'String'=>0, 'byte'=>1, 'char'=>1, 'short'=>1,
        ...
        @op_cats = ProbTab.new({'relational'=>2, 'boolean'=>1, 'integral'=>5, 'arith'=>30,
            ...
            'integral_assn'=>1, 'arith_assn'=>2, 'object_assn'=>0, 'array_assn'=>25, 'string_assn'=>1, 'string_oper'=>1})
