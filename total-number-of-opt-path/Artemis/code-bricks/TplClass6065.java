...
public class TplClass6065 {

    private static final void method(java.net.ServerSocket ss, java.util.concurrent.Phaser phaser, int port, int THREADS) throws Throwable {
        for (int i = 0; i < 100; i++) {
            try {
