...
public class TplClass6024 {

    private static final void method(java.io.File[] files, int i, java.lang.String[] cmdarray, boolean flag, java.lang.String cmd) throws Throwable {
        File f = files[i];
