...
rm -rf ${AE_ROOT}/total-number-of-opt-path/Artemis/out
mkdir -p ${AE_ROOT}/total-number-of-opt-path/Artemis/out
mkdir -p ${AE_ROOT}/total-number-of-opt-path/Artemis/out/out-log


export BLOCK_EXEC_FILE='javac'
export RCOV_FOCUS_FILES='opto'
export TIME_FILE="${AE_ROOT}/total-number-of-opt-path/Artemis/out/out-log"
...
cd artemi/ && timeout 12.5h \
    ...
    --seed-dir ${AE_ROOT}/total-number-of-opt-path/Artemis/preproduce-seeds/allfuzzer-100 \
    > ${AE_ROOT}/total-number-of-opt-path/Artemis/out/out.log 2> ${AE_ROOT}/total-number-of-opt-path/Artemis/out/out.err &
cd ..
