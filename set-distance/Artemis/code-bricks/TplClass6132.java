...
public class TplClass6132 {

    private static final void method(java.net.ServerSocket ss, java.lang.String s1_type, java.net.DatagramSocket dsock1, java.net.Socket sock1, int port, boolean gotBindException, java.net.InetAddress ia1, java.lang.Exception failed_exc, java.lang.String s2_type, boolean failed, java.net.InetAddress ia2) throws Throwable {
        try {
