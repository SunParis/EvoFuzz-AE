...
from utils import script_check, signal_name, kill_all_running_procs

_T = TypeVar('_T')
_R = TypeVar('_R')


class MprGenerator(Iterator[_T], Generic[_T]):
...
class MultiProcRunner(Generic[_T, _R]):
    ...
    def run(self, manager):
        ...
        if self.generator is None:
            print('* No generator is provided, nothing to do')
            return
