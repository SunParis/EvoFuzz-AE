...
export ALLFUZZER_LOG_FILE="${AE_ROOT}/set-distance/EvoFuzz/run.log"
...
rm -rf ${AE_ROOT}/set-distance/EvoFuzz/out
rm -rf ${AE_ROOT}/set-distance/EvoFuzz/seeds/new_seeds
rm -rf ${AE_ROOT}/set-distance/EvoFuzz/mut_seed_data
rm -f ${AE_ROOT}/set-distance/EvoFuzz/run.log

cd afz && "${AE_PYTHON}" main.py ${AE_ROOT}/set-distance/EvoFuzz/Config.yml > /dev/null 2> /dev/null &
cd ..
