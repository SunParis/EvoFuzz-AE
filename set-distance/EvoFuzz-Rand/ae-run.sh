...
export ALLFUZZER_LOG_FILE="${AE_ROOT}/set-distance/EvoFuzz-Rand/run.log"
...
rm -rf ${AE_ROOT}/set-distance/EvoFuzz-Rand/out
rm -rf ${AE_ROOT}/set-distance/EvoFuzz-Rand/seeds/new_seeds
rm -rf ${AE_ROOT}/set-distance/EvoFuzz-Rand/mut_seed_data
rm -f ${AE_ROOT}/set-distance/EvoFuzz-Rand/run.log

cd afz && "${AE_PYTHON}" main.py ${AE_ROOT}/set-distance/EvoFuzz-Rand/Config.yml > /dev/null 2> /dev/null &
cd ..
