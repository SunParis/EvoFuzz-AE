...
export TIME_FILE="${AE_ROOT}/set-distance/EvoFuzz-Coarse/out"
...
mkdir -p "${AE_ROOT}/set-distance/EvoFuzz-Coarse/out"
timeout 12.5h "${AE_PYTHON}" main.py --test-java-home $TEST_JAVA_HOME \
    ...
    --scheduler "true" \
    > ${AE_ROOT}/set-distance/EvoFuzz-Coarse/out/out.log \
    2> ${AE_ROOT}/set-distance/EvoFuzz-Coarse/out/out.err &
