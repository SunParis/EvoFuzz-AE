...
export TIME_FILE="${AE_ROOT}/set-distance/MopFuzzer/out"
...
mkdir -p "${AE_ROOT}/set-distance/MopFuzzer/out"
timeout 12.5h "${AE_PYTHON}" main.py --test-java-home $TEST_JAVA_HOME \
    ...
    --scheduler "false" \
    > ${AE_ROOT}/set-distance/MopFuzzer/out/out.log \
    2> ${AE_ROOT}/set-distance/MopFuzzer/out/out.err &
